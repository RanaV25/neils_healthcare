        ...
        <div className="container mx-auto max-w-7xl px-5 md:px-8">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-xl text-ink-secondary leading-relaxed">
              Telehealth consultations for all of Katy — Cinco Ranch, Cross Creek Ranch, Old Katy, and surrounding areas. Gentle, safe care for kids and adults. $50 for 30 minutes.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-bg-card border border-border-soft rounded-2xl p-8">
                ...
                <p className="text-sm text-ink-tertiary">
                  Same pricing: $50 for 30 minutes
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto max-w-7xl px-5 md:px-8">
          <div className="bg-bg-card-feature text-ink-on-dark rounded-3xl p-12 md:p-16 text-center space-y-6">
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
              Telehealth consultations across Katy. Gentle, safe care for kids and adults. Classical homeopathy. $50 for 30 minutes.
            </p>
