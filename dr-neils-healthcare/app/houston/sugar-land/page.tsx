        ...
        <div className="container mx-auto max-w-7xl px-5 md:px-8">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-xl text-ink-secondary leading-relaxed">
              Telehealth consultations for all of Sugar Land — First Colony, Telfair, Riverstone, Sweetwater, and surrounding areas. IIT and Stanford-trained practitioner. $50 for 30 minutes.
            </p>
        ...
        <div className="container mx-auto max-w-7xl px-5 md:px-8">
          <div className="bg-bg-card-feature text-ink-on-dark rounded-3xl p-12 md:p-16 text-center space-y-6">
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
              Telehealth consultations across Sugar Land. IIT and Stanford-trained. Classical approach. $50 for 30 minutes.
            </p>
